...
LIB_DST=~/.gradle/build/$BUILD_NAME/rootfw-stdlib
LIB_SRC="$LIB_PROJECT/src/main/java"
LIB_FILE="$LIB_DST/outputs/aar/rootfw-stdlib-$BUILD_TYPE.aar"
LIB_PKG="$LIB_PROJECT/releases/rootfw-stdlib-$BUILD_TYPE.aar"
DOC_DST="$LIB_PROJECT/docs/dokka"

BINTRAY_DST=~/.gradle/build/$BUILD_NAME/bintray
BINTRAY_PACKAGE="rootfw-stdlib"
...
<project xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd" xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <dependencies>
        <dependency>
            <groupId>com.spazedog.lib</groupId>
            <artifactId>rootfw</artifactId>
